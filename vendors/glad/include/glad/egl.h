/**
 * Loader generated by glad 2.0.4 on Tue Aug 15 17:21:08 2023
 *
...
#define EGL_ANDROID_create_api_client_buffer 1
GLAD_API_CALL int GLAD_EGL_ANDROID_create_api_client_buffer;
...
#define EGL_ANDROID_get_api_client_buffer 1
GLAD_API_CALL int GLAD_EGL_ANDROID_get_api_client_buffer;
#define EGL_ANDROID_image_api_buffer 1
GLAD_API_CALL int GLAD_EGL_ANDROID_image_api_buffer;
#define EGL_ANDROID_api_fence_sync 1
GLAD_API_CALL int GLAD_EGL_ANDROID_api_fence_sync;
...
#define EGL_NV_api_query 1
GLAD_API_CALL int GLAD_EGL_NV_api_query;
...
#define EGL_QNX_image_api_buffer 1
GLAD_API_CALL int GLAD_EGL_QNX_image_api_buffer;
#define EGL_QNX_platform_screen 1
GLAD_API_CALL int GLAD_EGL_QNX_platform_screen;
#define EGL_TIZEN_image_api_buffer 1
GLAD_API_CALL int GLAD_EGL_TIZEN_image_api_buffer;
#define EGL_TIZEN_image_api_surface 1
GLAD_API_CALL int GLAD_EGL_TIZEN_image_api_surface;
...
typedef EGLSurface (GLAD_API_PTR *PFNEGLCREATEPLATFORMPIXMAPSURFACEPROC)(EGLDisplay dpy, EGLConfig config, void * api_pixmap, const EGLAttrib * attrib_list);
typedef EGLSurface (GLAD_API_PTR *PFNEGLCREATEPLATFORMPIXMAPSURFACEEXTPROC)(EGLDisplay dpy, EGLConfig config, void * api_pixmap, const EGLint * attrib_list);
typedef EGLSurface (GLAD_API_PTR *PFNEGLCREATEPLATFORMWINDOWSURFACEPROC)(EGLDisplay dpy, EGLConfig config, void * api_window, const EGLAttrib * attrib_list);
typedef EGLSurface (GLAD_API_PTR *PFNEGLCREATEPLATFORMWINDOWSURFACEEXTPROC)(EGLDisplay dpy, EGLConfig config, void * api_window, const EGLint * attrib_list);
...
typedef EGLDisplay (GLAD_API_PTR *PFNEGLGETPLATFORMDISPLAYPROC)(EGLenum platform, void * api_display, const EGLAttrib * attrib_list);
typedef EGLDisplay (GLAD_API_PTR *PFNEGLGETPLATFORMDISPLAYEXTPROC)(EGLenum platform, void * api_display, const EGLint * attrib_list);

...
{
  class metal_program;
  using metal_program_ref = mgl::ref<metal_program>;

  class metal_program : public mgl::platform::api::program
  {
public:
    metal_program(const std::string& vs_source,
    ...
    mgl::metal::program_ref& native() { return m_program; }

private:
    mgl::metal::program_ref m_program;
  };
} // namespace mgl::platform::api::backends

...
namespace mgl::platform::gpu
{
  namespace
  {
    ...
    {
  private:
      void impl_begin_frame() override { api::render_api::instance().api_begin_frame(); }
      void impl_end_frame() override { api::render_api::instance().api_end_frame(); }
      void impl_begin_render_pass() override { api::render_api::instance().api_begin_render_pass(); }
      void impl_end_render_pass() override { api::render_api::instance().api_end_render_pass(); }
      ...
      void impl_enable_scissor() override { api::render_api::instance().api_enable_scissor(); }
      void impl_disable_scissor() override { api::render_api::instance().api_disable_scissor(); }
      ...
      {
        api::render_api::instance().api_enable_state(state);
      }
      void impl_disable_state(int32_t state) override
      {
        api::render_api::instance().api_disable_state(state);
      }
      ...
      {
        api::render_api::instance().api_render_call(

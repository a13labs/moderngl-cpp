...
public:
    ...
    bool
    read_into(mgl::byte_buffer& dst, int level = 0, int alignment = 1, size_t write_offset = 0);
    bool read_into(buffer_ref& dst, int level = 0, int alignment = 1, size_t write_offset = 0);

    bool write(const mgl::byte_buffer& src,
               const mgl::rect& viewport,
               int level = 0,
               int alignment = 1);
    bool write(const mgl::byte_buffer& src, int level = 0, int alignment = 1);

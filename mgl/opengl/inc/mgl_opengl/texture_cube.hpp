...
public:
    ...
    void read(mgl::uint8_buffer& dst, int face, int alignment = 1, size_t write_offset = 0);
    void read(buffer_ref& dst, int face, int alignment = 1, size_t write_offset = 0);

    void
    write(const mgl::uint8_buffer& src, int face, const mgl::rect& viewport, int alignment = 1);
    void write(const mgl::uint8_buffer& src, int face, int alignment = 1);
    void write(const buffer_ref& src, int face, const mgl::rect& viewport, int alignment = 1);
    void write(const buffer_ref& src, int face, int alignment = 1);

...
public:
    ...
    void set_uniform_value(const std::string& name, const uniform_value& value)
    {
      ...
      switch(value.type)
      {
        case uniform_type::BOOL: (*m_program)[name]->set_value(value.data.b); break;
        case uniform_type::INT: (*m_program)[name]->set_value(value.data.i); break;
        case uniform_type::UINT: (*m_program)[name]->set_value(value.data.u); break;
        case uniform_type::FLOAT: (*m_program)[name]->set_value(value.data.f); break;
        case uniform_type::VEC2: (*m_program)[name]->set_value(value.data.vec2); break;
        case uniform_type::VEC3: (*m_program)[name]->set_value(value.data.vec3); break;
        case uniform_type::VEC4: (*m_program)[name]->set_value(value.data.vec4); break;
        case uniform_type::MAT2: (*m_program)[name]->set_value(value.data.mat2); break;
        case uniform_type::MAT2X3: (*m_program)[name]->set_value(value.data.mat2x3); break;
        case uniform_type::MAT2X4: (*m_program)[name]->set_value(value.data.mat2x4); break;
        case uniform_type::MAT3: (*m_program)[name]->set_value(value.data.mat3); break;
        case uniform_type::MAT3X2: (*m_program)[name]->set_value(value.data.mat3x2); break;
        case uniform_type::MAT3X4: (*m_program)[name]->set_value(value.data.mat3x4); break;
        case uniform_type::MAT4: (*m_program)[name]->set_value(value.data.mat4); break;
        case uniform_type::MAT4X2: (*m_program)[name]->set_value(value.data.mat4x2); break;
        case uniform_type::MAT4X3: (*m_program)[name]->set_value(value.data.mat4x3); break;
      }
    }

...
namespace mgl::metal
{
  class framebuffer : public object, public mgl::ref_from_this<framebuffer>
  {
public:
    ~framebuffer() = default;
    ...
    void set_color_mask(const metal::color_mask& mask);
    ...
    void set_color_mask(const metal::color_masks& masks);
...
private:
  ...
  using framebuffer_ref = mgl::ref<mgl::metal::framebuffer>;
  using framebuffer_weak_ref = mgl::weak_ref<mgl::metal::framebuffer>;

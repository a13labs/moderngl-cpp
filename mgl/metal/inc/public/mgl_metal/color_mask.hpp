...
namespace mgl::metal
{
   ...
   *
   * The color mask is a boolean value that represents whether the red, green, blue, and alpha
   * components of the color buffer are written to.
   */
  struct color_mask
  {
    bool r, g, b, a;
    ...
    /**
     * @brief The color_mask constructor creates a new color mask with the specified red, green,
    ...
    /**
     * @brief The color_mask constructor creates a new color mask with the specified red, green, and
     * blue components.
     *
     * @param r The red component.
     * @param g The green component.
    ...
    /**
     * @brief The color_mask constructor creates a new color mask with the specified red and green
     * components.
     *
     * @param r The red component.
     * @param g The green component.
    ...
    /**
     * @brief The operator& method returns the logical AND of the color mask with another color
     * mask.
     *
     * @param other The other color mask.
    ...
    /**
     * @brief The operator&= method performs a logical AND of the color mask with another color mask
     * and assigns the result to the color mask.
     *
     * @param other The other color mask.
    ...
    /**
     * @brief The operator|= method performs a logical OR of the color mask with another color mask
     * and assigns the result to the color mask.
     *
     * @param other The other color mask.
     * @return The color mask.

...
namespace mgl::metal
{
  ...
  void texture_3d::read(mgl::uint8_buffer& dst, int32_t lvl, int32_t align, size_t dst_off)
  {
    // TODO: Implement texture read
    MGL_CORE_ASSERT(false, "Not implemented yet");
  }

  void texture_3d::read(buffer_ref& dst, int32_t lvl, int32_t align, size_t dst_off)
  {
    // TODO: Implement texture read to buffer
    MGL_CORE_ASSERT(false, "Not implemented yet");
  }

  void texture_3d::write(const mgl::uint8_buffer& src, const mgl::rect& v, int32_t lvl, int32_t align)
  {
    ...
    MTLRegion region = MTLRegionMake3D(v.x, v.y, 0, v.width, v.height, m_depth_size);
  ...
  void texture_3d::write(const mgl::uint8_buffer& src, int32_t lvl, int32_t align)
  {
    mgl::rect full_rect = {0, 0, m_width, m_height};
    write(src, full_rect, lvl, align);
  }

  void texture_3d::write(const buffer_ref& src, const mgl::rect& v, int32_t lvl, int32_t align)
  {
  ...
  void texture_3d::resize(int32_t w, int32_t h, int32_t d, int32_t components, const mgl::uint8_buffer& data)
  {
    // TODO: Implement texture resize
    MGL_CORE_ASSERT(false, "Not implemented yet");
  }

  void texture_3d::bind_to_image(int32_t unit, bool read, bool write, int32_t lvl, int32_t f)
  {
